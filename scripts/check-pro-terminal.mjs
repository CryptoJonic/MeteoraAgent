...
const checks = [
  ...
  ['two-tap mobile drawing', /drawingAwaitSecond/.test(sw) && /Луч: коснись начала/.test(sw) && /Линейка: коснись начала/.test(sw)],
  ['manual marker hidden', /p&&p\.source!==['"]manual['"]/.test(sw)],
  ['target mode hides reclaim', /c\.exitMode!==['"]target['"]/.test(sw) && /RECLAIM/.test(sw)],
